...
graph_c <- data.frame(assessment_interval = ai_lowerror$assess_int, productivity = rep("constant", 5), prop_bad = ai_lowerror_all$prop_bad)
graph_u <- data.frame(assessment_interval = ai_lowerror_u$assess_int, productivity = rep("updating", 5), prop_bad = ai_lowerror_all_u$prop_bad)
...
graph_c1500 <- data.frame(assessment_interval = ai_lowerror$assess_int, productivity = rep("constant", 5), prop_bad = ai_lowerror$prop_bad)
graph_u1500 <- data.frame(assessment_interval = ai_lowerror$assess_int, productivity = rep("updating", 5), prop_bad = ai_lowerror_u$prop_bad)
