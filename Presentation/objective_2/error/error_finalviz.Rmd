...
prop_graph <- ggplot(graph_df, aes(x= fct_rev(error), y=prop)) + 
...
prop_graph
ggsave(prop_graph, filename = "error.png",  bg = "transparent")
...
prop_100_both <- ggplot(graph_both, aes(x=fct_rev(error), y = prop, fill = productivity)) + 
