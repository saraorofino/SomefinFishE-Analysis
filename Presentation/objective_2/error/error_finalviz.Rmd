...
over_c <- data.frame(error = prop_filtered$error, type = rep("over",3), prop = prop_filtered$prop_over, productivity = rep("constant", 3))
closed_c <- data.frame(error = prop_filtered$error, type = rep("closed",3), prop = prop_filtered$prop_closed, productivity = rep("constant", 3))
