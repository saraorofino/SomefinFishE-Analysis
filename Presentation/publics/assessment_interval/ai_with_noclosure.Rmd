...
## Graph Constant FMSY:
```{r graph-constant}
ai_c <- ggplot(ai_props_c, aes(x = assess_int, y = prop_over)) +
...
```{r graph-both}
ai_both <- ggplot(graph_both, aes(x = assessment_interval, y = prop_over, fill = productivity)) +
