...
#Baseline model with error around the f_ratio (f/fmsy) and a reassessment window of 15 years:
...
sim_ai <- function(b, r, r_s, error, p, k, years, hcr){ 
  ...
  # 15 year asssessment interval - make the HCR decision based on the previous years data and apply the f to the current assessment year, this f remains constant until next assessment
  for (t in 2:years) {
...
# #Write as CSV:
# library(here)
#  write.csv(results_ai, file=file.path(here(),"Results/assessment_intervals/ai_constantfmsy_15rep_hcr30.csv"),
#            row.names = FALSE)
