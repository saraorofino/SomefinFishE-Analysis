...
results_rep10c_edit <- results_rep10c %>% 
  ...
  mutate(ratio_err_cat = case_when(results_rep10c$V9 == 0 ~ 0,
                               results_rep10c$V9 > 0 & results_rep10c$V9 <= 1 ~ 1,
                               results_rep10c$V9 > 1 & results_rep10c$V9 < 2 ~ 2,
                               results_rep10c$V9 > 2 ~ 3)) %>%
