...
check_result_msy10c <- sim_msy10c(b=6000, r=0.2, r_s=-0.01767, error=0.3, p=0.2, k=10000, years=100)
```
...
results_msy10c_edit <- results_msy10c %>%
  mutate(ratio_cat = case_when(results_msy10c$V7 == 0 ~ 0,
                               results_msy10c$V7 <= 1 & results_msy10c$V7 != 0 ~ 1,
                               results_msy10c$V7 > 1 & results_msy10c$V7 < 2 ~ 2,
                               results_msy10c$V7 > 2 ~ 3)) %>% 
  mutate(ratio_err_cat = case_when(results_msy10c$V9 == 0 ~ 0,
                               results_msy10c$V9 > 0 & results_msy10c$V9 <= 1 ~ 1,
                               results_msy10c$V9 > 1 & results_msy10c$V9 < 2 ~ 2,
                               results_msy10c$V9 > 2 ~ 3)) %>%
