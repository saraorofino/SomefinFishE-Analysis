---
title: "hcr_discussion_runs"
output: html_document
---

#{.tabset}

This HCR model will be used to run all the discussion results files.

We want to run the full range of HCRs for assessment intervals 0, 1, 5, 10, 15, and 20 at each of the error levels.


##Intervals


Note: Define the assessment interval and run at 0.5 error four times (change file names), then repeat at 0.3 error then 0.1 before coming back to the top and changing the assessment interval  
```{r setup}
...
sim_hcr <- function(b, r, r_s, error, p, k, years, hcr){ #hcr term is added into the model to run a cross list of a number of different hcr possibilities
...
##Save CSV
Remember to save each file different. File format should be (high-med-low)err_(rep#)_run#
```{r save-csv}
...
#Write as CSV:
library(here)
 write.csv(results_hcr, file=file.path(here(),"/Results/discussion_runs/higherror/run5/higherr_20_run5.csv"),
           row.names = FALSE)
