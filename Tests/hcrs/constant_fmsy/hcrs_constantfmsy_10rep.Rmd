...
The harvest control rules (5% - 50% reduction) will be tested over a range of climate impacts, initial growth rates, and initial biomasses.
...
Goal: Simulate the effect of different harvest control rules in the face of climate change.
...
check_result_hcr <- sim_hcr(b=1500, r=0.2, r_s=-0.005, error=0.10, p=0.2, k=10000, years=100, hcr = .9)
```
...
#Write as CSV:
#library(here)
# write.csv(results_hcr, file=file.path(here(),"/Results/hcrs/hcrs_constantfmsy_10rep.csv"),
#           row.names = FALSE)
