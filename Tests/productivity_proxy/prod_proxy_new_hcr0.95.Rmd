...
#Write as CSV:
library(here)
write.csv(results_proxy, file=file.path(here(),"/Results/productivity_proxy/for_publics/new_model/hcr_0.95_allerr/proxy_new_1.csv"),
           row.names = FALSE)
