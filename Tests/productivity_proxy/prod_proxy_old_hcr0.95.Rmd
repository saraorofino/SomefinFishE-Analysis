...
library(here)
write.csv(results_proxy, file=file.path(here(),"/Results/productivity_proxy/for_publics/old_model/hcr_0.95_allerr/proxy_old_1.csv"),row.names = FALSE)
