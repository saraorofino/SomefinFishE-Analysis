...
sim_shock10c <- function(b, r, r_s, error, p, k, years){ 
...
check_result_shock10c <- sim_shock10c(b=6000, r=0.2, r_s=-0.01767, error=0.3, p=0.2, k=10000, years=100)
```
...
for(i in 1:408){
  results[[i]] <- sim_shock10c(b=input_shock10c[[i]]$b, r=input_shock10c[[i]]$r,
                             r_s=input_shock10c[[i]]$r_s, p=input_shock10c[[i]]$p,
                             k=input_shock10c[[i]]$k, years=input_shock10c[[i]]$years, 
                             error = input_shock10c[[i]]$error)
}
