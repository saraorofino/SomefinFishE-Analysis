...
Shock events:
  ...
  - During an El Nino year the productivity of the fishery decreases by 10%
...
sim_shock10u <- function(b, r, r_s, error, p, k, years){
...
check_result_shock10u <- sim_shock10u(b=6000, r=0.2, r_s=-0.01767, error=0.3, p=0.2, k=10000, years=100)
```
...
for(i in 1:408){
  results[[i]] <- sim_shock10u(b=input_shock10u[[i]]$b, r=input_shock10u[[i]]$r,
                             r_s=input_shock10u[[i]]$r_s, p=input_shock10u[[i]]$p,
                             k=input_shock10u[[i]]$k, years=input_shock10u[[i]]$years, 
                             error = input_shock10u[[i]]$error)
}
