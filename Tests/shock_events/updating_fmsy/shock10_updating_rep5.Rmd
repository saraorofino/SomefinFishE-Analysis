...
sim_shock5u <- function(b, r, r_s, error, p, k, years){
...
check_result_shock5u <- sim_shock5u(b=6000, r=0.2, r_s=-0.01767, error=0.3, p=0.2, k=10000, years=100)
```
...
for(i in 1:408){
  results[[i]] <- sim_shock5u(b=input_shock5u[[i]]$b, r=input_shock5u[[i]]$r,
                             r_s=input_shock5u[[i]]$r_s, p=input_shock5u[[i]]$p,
                             k=input_shock5u[[i]]$k, years=input_shock5u[[i]]$years, 
                             error = input_shock5u[[i]]$error)
}
